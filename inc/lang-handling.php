...
require get_template_directory() . '/inc/lang/_taxonomy.php'; // Register new taxonomy
require get_template_directory() . '/inc/lang/_iso-code.php'; // Adds ISO code custom field
